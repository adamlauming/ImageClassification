...
parser.add_argument('--model', default='T0410-1135-densenet121-MSFM-b8-320-bv-data', type=str, help="get center type")
...
parser.add_argument('--network', default='densenet121-M2E', type=str, help="get center type")
...
weightname = os.path.join(path, '..', Flags.model, 'Model', 'Model_Ep45_AUC_0.9207.pkl')
...
pred_dir = os.path.join(save_dir, 'MultiCla.csv')
