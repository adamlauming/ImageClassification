...
class classifer_base(nn.Module):
    ...
    def __init__(self, backbone='resnet50', pretrained_base=True, n_class=11, in_channel=3, **kwargs):
...
class classifer_base2(nn.Module):
    def __init__(self, Flags):
        super().__init__()
        self.encoder = smp.FPN(Flags.model, in_channels=Flags.inchannels, encoder_weights='imagenet').encoder
