...
from model.base_models.AttNet.modules import *
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, norm_layer=nn.BatchNorm2d, in_channel=3):
        ...
        self.se1 = SELayer(64, 16) # reduction: 16
